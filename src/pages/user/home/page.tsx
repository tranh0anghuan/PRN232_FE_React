          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <CardDescription className="text-center text-gray-600">
                    Monitor your health improvements, money saved, and
                    smoke-free days. Celebrate every milestone achieved.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <CardDescription className="text-center text-gray-600">
                    Get immediate help when cravings hit. Our crisis support
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <CardDescription className="text-center text-gray-600">
                    Evidence-based techniques including CBT, mindfulness, and
                    NRT guidance to maximize your success.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-white border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    "After 20 years of smoking, I never thought I could quit.
                    The personalized plan and community support made all the
              ...
              <Card className="bg-white border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    "The 24/7 support was a lifesaver during my toughest
                    moments. Having someone to talk to when cravings hit made
                    quitting possible for me."
                  </p>
                  <div className="flex items-center">
              ...
              <Card className="bg-white border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    "I tried quitting many times before. The progress tracking
                    and community encouragement kept me motivated. Best decision
                    I ever made!"
                  </p>
                  <div className="flex items-center">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-green-100">
                ...
                proven support system. Your healthier future starts today.
              </p>
